...
Controls keep the existing 2px corner radius. The logo geometry in `components/mark-geometry.ts` remains authoritative for shared brand assets. The owner-requested W/Y proportion adjustment lives in the shared geometry: the static navbar/footer mark and hero animation all align their painted letter tops and bottoms to the ring, while width and stroke weight stay consistent.
