...
try {
  ...
  const report = { pages, jsErrors: errors, accessibility, overflow, brokenLinks, checkedLinks: hrefs.size, checkedAssets: assets.size, interactions: "cookie choices, theme memory, mobile menu/Escape, accordion, validation, unavailable delivery, mocked success/duplicate prevention passed" };
