...
- Organization and WebSite entities establish one shared site identity. The Organization email is the owner-provided `hello@woyconsulting.com`, also visible in the footer, contact page and FAQ. Content pages add relevant page/breadcrumb, service, person and case-study entities based on the published copy. FAQ data mirrors visible answers. No ratings, addresses, credentials, client identities or unsupported outcomes are fabricated.
